...
DOCKER_SERVICE_MARIADB_MASTER:=mariadb-master
DOCKER_SERVICE_MARIADB_SLAVE:=mariadb-slave
...
ifeq ($(EXECUTE_IN_CONTAINER),true)
    ...
    EXECUTE_IN_APPLICATION_MASTER:=$(DOCKER_COMPOSE) exec -T $(DOCKER_SERVICE_MARIADB_MASTER)
	EXECUTE_IN_APPLICATION_SLAVE:=$(DOCKER_COMPOSE) exec -T $(DOCKER_SERVICE_MARIADB_SLAVE)
endif
